...
try:
    ...
    while True:
        ...
        if humidity is None or temp is None or humidity2 is None or temp2 is None or humidity3 is None or temp3 is None or humidity4 is None or temp4 is None: # + Second Sensor
           time.sleep(4)
           continue
